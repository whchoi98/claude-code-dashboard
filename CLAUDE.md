...
│   ├── pages/              17 routes (Overview, Executive, Users, UserProductivity, UserSearch, Trends, ClaudeCode, Cowork, Office, Design, Productivity, Adoption, Cost, Compliance, Analyze, Archive, Changelog). Default date range is 7d. The DateRangeControl now allows today as the end date (engagement endpoints clamp to the 3-day buffer server-side; the cost family serves recent days with partial data).
