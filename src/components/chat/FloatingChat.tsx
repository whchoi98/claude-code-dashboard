    ...
    <>
      ...
      {open && (
        <div
          ...
          className="fixed bottom-6 right-6 z-40 w-[400px] max-w-[calc(100vw-2rem)] h-[600px] max-h-[calc(100vh-3rem)] rounded-2xl border border-ink-100 bg-paper-muted/95 backdrop-blur shadow-2xl flex flex-col p-3 print-hide"
        >
          <div
